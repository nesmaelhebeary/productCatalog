package com.hypercell.productcatalog.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("productCatalog");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("productCatalog");
        ...
        config.getMapConfigs().put("com.hypercell.productcatalog.domain.*", initializeDomainMapConfig(jHipsterProperties));
